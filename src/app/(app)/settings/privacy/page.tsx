      ...
      <div className="space-y-6">
        <Card className="rounded-3xl">
          <CardHeader>
            ...
            <CardDescription>
              Blocked members can&apos;t see you or contact you anywhere on Amora.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {blocks.length === 0 ? (
        ...
        <Card className="rounded-3xl">
          <CardHeader>
            ...
            <CardDescription>
              Download a copy of everything Amora holds about you — profile, activity, messages and
