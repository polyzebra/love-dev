    ...
    <PageShell width="reading">
      <article className="prose prose-neutral dark:prose-invert">
        ...
        <ul>
          ...
          <li>
            <strong>Photo verification</strong> confirms that the photos on your profile are
            actually of you. It does <em>not</em> check a government document. A &ldquo;Photo
            verified&rdquo; badge never means we verified your ID.
          </li>
        </ul>

        <h2>Why a video selfie?</h2>
        <p>
          To confirm your photos are you, we need a trusted picture of you to compare them against.
          We create it from a short <strong>video selfie liveness check</strong> - a video, not a
          still, because a video is far harder to fake with a printed photo or a screen. We never
          build that reference from your existing profile photos (that would let someone verify
          stolen pictures).
        </p>
        ...
        <ul>
          <li>
            A short video selfie, captured and analysed by our verification partner in the EU.
          </li>
          <li>
        ...
        <p>
          Identity verification: Stripe. Photo verification: a face-comparison provider processing
          in the EU. Availability may be limited by country during rollout.
        </p>

        <p>
          Full detail: <Link href={LEGAL_ROUTES.biometricData}>Biometric data notice</Link> ·{" "}
