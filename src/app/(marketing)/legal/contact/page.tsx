  ...
  return (
    <>
      ...
      <p>
        ...
        in the <Link href={LEGAL_ROUTES.compliance}>Compliance Statement</Link>. Official company
      ...
      <p>
        ...
        erasure, restriction, or objection - see{" "}
        <Link href={LEGAL_ROUTES.gdpr}>Your data rights</Link> and the{" "}
        <Link href={LEGAL_ROUTES.privacy}>Privacy Policy</Link>. To submit a request, use the{" "}
        <Link href="/contact">contact form</Link> and choose &quot;Privacy or data request&quot;.
        Retention periods are in the{" "}
        <Link href={LEGAL_ROUTES.dataRetention}>Data Retention Policy</Link>, and account deletion
        in the <Link href={LEGAL_ROUTES.accountDeletion}>Account Deletion Policy</Link>.
      </p>

      <h2>Copyright &amp; trademark</h2>
      <p>
        To report copyright infringement, see the{" "}
        <Link href={LEGAL_ROUTES.copyright}>Copyright Policy</Link>. For brand, logo, and trademark
        use, see the brand guidelines on the <Link href="/press">Press page</Link>.
      </p>

      <h2>Law enforcement &amp; court orders</h2>
      <p>
        Authorities making a lawful request for user data should follow the{" "}
        <Link href={LEGAL_ROUTES.lawEnforcement}>Law Enforcement Guidelines</Link>, which set out
        how we handle preservation, disclosure, court orders, and emergency requests.
      </p>

      <h2>Security &amp; vulnerability disclosure</h2>
      <p>
        To report a security vulnerability, follow the{" "}
        <Link href={LEGAL_ROUTES.vulnerabilityDisclosure}>Vulnerability Disclosure Policy</Link>.
        Our security practices are described in the{" "}
        <Link href={LEGAL_ROUTES.security}>Security Policy</Link>.
      </p>
      ...
      <ul>
        ...
        <li>
          Governing law: Ireland - see the <Link href={LEGAL_ROUTES.terms}>Terms of Service</Link>.
        </li>
      </ul>
    </>
  );
