    ...
    <PageShell width="reading">
      <article className="prose prose-neutral dark:prose-invert">
        ...
        <p>
          ...
          face in the oval, and stay still. You can retry right away - retries never create
          duplicate sessions.
        </p>
        ...
        <p>
          ...
          of someone else can&apos;t be your cover. Pick a clear solo photo of yourself and the
          badge returns.
        </p>
        ...
        <p>
          ...
          <Link href={LEGAL_ROUTES.biometricData}>Biometric data notice</Link>.
        </p>
      </article>
    </PageShell>
  );
