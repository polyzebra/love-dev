...
function RowBody({
  ...
  return (
    <>
      <span
        className="bg-foreground/5 flex size-9 shrink-0 items-center justify-center rounded-full"
        aria-hidden="true"
      >
        {icon}
      </span>
        ...
        field={
          <>
            ...
            <p className="text-muted-foreground mt-6 text-sm leading-relaxed text-pretty">
              Using Google? The account chooser lists every Google identity on this device - pick
              the email address your Tirvea account uses. Choosing a different one signs you into a
              different (or brand-new) account.
            </p>
          </>
        }
        footnote={
