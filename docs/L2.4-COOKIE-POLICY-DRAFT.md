...
|---|---|---|
| Prior consent for non-essential cookies (ePrivacy Art. 5(3)) | §4, §12-§14 and §23 | ✅ Designed; ⬜ tool to build |
| Strictly-necessary exemption applied correctly | §6-§9 and §16 | ✅ / ⬜ verify Stripe/AWS classification |
...
| Local-storage treated as "similar technology" | §2 and §10 | ✅ / ⬜ ePrivacy classification of functional local storage |
| No analytics/marketing without consent (accuracy) | §12-§14 and §20-§21 | ✅ Verified against codebase |
